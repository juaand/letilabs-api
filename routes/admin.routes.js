...
router.get('/modalwork', adminController.getModalWork)
...
router.get('/ethicsdata', adminController.getEthics)
router.patch('/updatecarrerasdata', routeGuard.isAuthenticated, adminController.updateCarrerasData)
router.patch('/updateethicsdata', routeGuard.isAuthenticated, adminController.updateEthicsData)
