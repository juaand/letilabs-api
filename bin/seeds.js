...
Promise.all([
  ...
  .then(() => {
    ...
    const cookieInfo = new Cookie({
      info: 'Utilizamos cookies para poder ofrecerle la mejor experiencia posible en el sitio web. Esto incluye las cookies que son necesarias para el funcionamiento del sitio web, así como otras cookies que se utilizan únicamente con fines estadísticos anónimos.'
    })
    cookieInfo.save()
